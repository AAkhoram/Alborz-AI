...
def get_batch(
    ...
    # بهینه‌سازی: به‌جای لیست + stack، تنسورها رو از اول روی دستگاه مقصد
    # اختصاص می‌دیم و مستقیماً پر می‌کنیم (کم کردن overhead پایتون)
...
def train(
    ...
    # بهینه‌سازی: autocast فقط اگه use_amp=True و دستگاه CPU bfloat16 رو پشتیبانی کنه
